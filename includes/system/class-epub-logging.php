...
class EPUB_Logging {
	...
	const LOGGING_OPTION_NAME =  'epub_error_log';
	...
	public static function add_log_var( $error_message, $variable, $wp_error=null  ) {
		self::add_log( $error_message . ': ' . EPUB_Utilities::get_variable_string( $variable ), $wp_error );
	}
	...
	private static function can_log_message() {
		return ( current_user_can( 'manage_options' ) || defined('EPUB_TEST_ON') ) ;
	}
	...
	public static function generateStackTrace()
	{
		...
		$stackMsg = substr( $stackMsg, 0, 200);
